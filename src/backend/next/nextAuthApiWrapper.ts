 ...
 */
export type NextAuthApiMethodInput = {
    req: NextApiRequest
    res: NextApiResponse
 ...
 */
export default class NextAuthApiWrapper {
    private _req!: NextApiRequest
    private _res!: NextApiResponse

    // Methods
    private _read: NextApiMethod | NextAuthApiMethodWithAuthOptions | undefined
    private _write: NextApiMethod | NextAuthApiMethodWithAuthOptions | undefined
    private _update: NextApiMethod | NextAuthApiMethodWithAuthOptions | undefined
    private _replace: NextApiMethod | NextAuthApiMethodWithAuthOptions | undefined
    private _remove: NextApiMethod | NextAuthApiMethodWithAuthOptions | undefined
    ...
    private async _executeMethod(
        method: NextApiMethod | NextAuthApiMethodWithAuthOptions,
        methodInput: NextAuthApiMethodInput,
    ) {
